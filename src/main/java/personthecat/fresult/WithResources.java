...
public class WithResources<R1 extends AutoCloseable, R2 extends AutoCloseable> {

    private final ThrowingSupplier<R1, Throwable> r1Getter;
    private final ThrowingSupplier<R2, Throwable> r2Getter;

    WithResources(final ThrowingSupplier<R1, Throwable> r1Getter, final ThrowingSupplier<R2, Throwable> r2Getter) {
     ...
     */
    public <T, E extends Throwable> Result.Pending<T, E> of(final ThrowingBiFunction<R1, R2, T, E> attempt) {
     ...
     */
    public <E extends Throwable> Result.Pending<Void, E> of(final ThrowingBiConsumer<R1, R2, E> attempt) {
     ...
     * @return A result which may either be a value or an error.
     */
    public <T, E extends Throwable> Result.Pending<T, E> of(final ThrowingFunction<R2, T, E> attempt) {
     ...
     */
    public <E extends Throwable> Result.Pending<Void, E> of(final ThrowingConsumer<R2, E> attempt) {
     ...
     */
    public <T, E extends Throwable> Result<T, Throwable> suppress(final ThrowingBiFunction<R1, R2, T, E> attempt) {
     ...
     */
    public <E extends Throwable> Result<Void, Throwable> suppress(final ThrowingBiConsumer<R1, R2, E> attempt) {
     ...
     */
    public <T, E extends Throwable> Result<T, Throwable> suppress(final ThrowingFunction<R2, T, E> attempt) {
     ...
     * @return A result which may either OK or an error.
     */
    public <E extends Throwable> Result<Void, Throwable> suppress(final ThrowingConsumer<R2, E> attempt) {
     ...
     */
    public <T, E extends Throwable> PartialOptionalResult<T, E> nullable(final ThrowingBiFunction<R1, R2, T, E> attempt) {
     ...
     * @return A result which may either be a value, an error, or null.
     */
    public <T, E extends Throwable> PartialOptionalResult<T, E> nullable(final ThrowingFunction<R2, T, E> attempt) {
     ...
     */
    public <T, E extends Throwable> OptionalResult<T, Throwable> suppressNullable(final ThrowingBiFunction<R1, R2, T, E> attempt) {
     ...
     * @return A result which may either be a value, <b>any</b> error, or null.
     */
    public <T, E extends Throwable> OptionalResult<T, Throwable> suppressNullable(final ThrowingFunction<R2, T, E> attempt) {
     ...
     * @return A result which may either be a value, an error, or null.
     */
    public <T, E extends Throwable> PartialOptionalResult<T, E> nullable(final ThrowingOptionalBiFunction<R1, R2, T, E> attempt) {
     ...
     * @return A result which may either be a value, an error, or null.
     */
    public <T, E extends Throwable> PartialOptionalResult<T, E> nullable(final ThrowingOptionalFunction<R2, T, E> attempt) {
        return this.nullable((R1 r1, R2 r2) -> attempt.apply(r2));
    }
     ...
     * @return A result which may either be a value, <b>any</b> error, or null.
     */
    public <T, E extends Throwable> OptionalResult<T, Throwable> suppressNullable(final ThrowingOptionalBiFunction<R1, R2, T, E> attempt) {
        return this.suppressNullable((ThrowingBiFunction<R1, R2, T, E>) (r1, r2) -> attempt.apply(r1, r2).orElse(null));
    }
     ...
     * @return A result which may either be a value, <b>any</b> error, or null.
     */
    public <T, E extends Throwable> OptionalResult<T, Throwable> suppressNullable(final ThrowingOptionalFunction<R2, T, E> attempt) {
        return this.suppressNullable((R1 r1, R2 r2) -> attempt.apply(r2));
    }
     ...
     */
    private <T, E extends Throwable> T execute(final ThrowingBiFunction<R1, R2, T, E> attempt) throws E {
